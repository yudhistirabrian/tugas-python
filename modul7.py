...
b[0][i]["text"]==b[1][i]["text"]==b[2][i]["text"]==a):
            messagebox.showinfo("Selamat!!","'"+a+"' Anda Menang")
            reset()
...
b[0][2]["text"]==b[1][1]["text"]==b[2][0]["text"]==a):
    ...
    elif(b[0][0]["state"]==b[0][1]["state"]==b[0][2]["state"]==b[1][0]["state"]==b[1][1
]["state"]==b[1][2]["state"]==b[2][0]["state"]==b[2][1]["state"]==b[2][2]["state"]==DISABLED):
        messagebox.showinfo("WOoww!!","Seri")
        reset()
def click(row,col):
